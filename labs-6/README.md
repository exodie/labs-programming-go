...
2. [x]	Использование каналов для передачи данных:
...
3. [x]	Применение select для управления каналами:
...
4. [x]	Синхронизация с помощью мьютексов:
...
5. [x]	Разработка многопоточного калькулятора:
